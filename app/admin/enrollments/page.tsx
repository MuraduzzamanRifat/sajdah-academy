          ...
          <article key={a.id} className="bg-white border border-slate-200 rounded-2xl p-5">
            <div className="flex flex-col lg:flex-row lg:items-start gap-4">
              ...
              <div className="flex gap-2 shrink-0 flex-wrap">
                ...
                <button type="button" className="inline-flex items-center gap-1.5 px-3 py-2 border border-rose-200 hover:bg-rose-50 text-rose-700 rounded-lg text-xs font-bold">
                  <X className="w-3.5 h-3.5" /> বাতিল
                </button>
                <button type="button" className="inline-flex items-center gap-1 px-2 py-2 text-slate-500 hover:text-slate-900 text-xs">

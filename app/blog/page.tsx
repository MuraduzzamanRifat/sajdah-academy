          ...
          >
            <div className="grid md:grid-cols-3 gap-6 items-center">
              <div className="md:col-span-2">
                ...
                <p className="text-slate-700 leading-relaxed mb-4">{featured.excerpt}</p>
                <div className="flex flex-wrap items-center gap-4 text-sm text-slate-500">
                  <span className="flex items-center gap-1.5">
                    <Calendar className="w-4 h-4" /> {formatDate(featured.date)}
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Clock className="w-4 h-4" /> {featured.readingMinutes} min read
                  </span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {rest.map((p) => (
              ...
              >
                ...
                <p className="text-sm text-slate-600 leading-relaxed line-clamp-3 mb-4">{p.excerpt}</p>
